...
--------------
    ...
    Description:
        현재 위치의 파일들을 NSML server 로 보내 세션을 실행시킵니다. 현재 위치의 main.py 를 entry 파일로 인식해서 실행시키고, entry 파일이 없으면 에러가 발생합니다. -e 옵션으로 entry 파일을 바꿀 수 있습니다.
    ...
    Example:
        ...
        해당되는 competition에 따라 -d 옵션을 설정하여 dataset을 꼭 지정해주셔야 합니다.
        (-d NER, -d SRL)
